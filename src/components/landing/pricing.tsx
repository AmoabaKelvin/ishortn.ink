  ...
  return (
    <section
      className={clsx([
        ...
        featured
          ? "order-first bg-velaGreen py-8 lg:order-none"
          : "bg-white lg:py-8",
      ])}
    >
      <h3
        ...
        <div className="md:text-center">
          <h2 className="text-3xl tracking-tight font-display sm:text-4xl">
            <span className="relative whitespace-nowrap">
              <SwirlyDoodle className="absolute left-0 top-1/2 h-[1em] w-full fill-velaGreen" />
              <span className="relative">Simple pricing,</span>
            </span>{" "}
            for everyone.
          </h2>
          <p className="mt-4 text-lg text-slate-400">
            It doesn’t matter what size your business is, we have something for
            you
          </p>
        </div>
