      ...
      <Transition.Root>
        ...
        >
          ...
          >
            ...
            <MobileNavLink href="/">Github</MobileNavLink>
            <hr className="m-2 border-slate-300/40" />
            <MobileNavLink href="/">Twitter</MobileNavLink>
            <hr className="m-2 border-slate-300/40" />
...
export function Header() {
  return (
    <header className="py-5 border-b border-opacity-10 border-slate-900">
      <Container>
        <nav className="relative z-50 flex items-center justify-between">
            ...
            <div className="hidden md:flex md:gap-x-6">
              <Link href="#features">
                <Button variant="ghost">
                  <span className="text-[1rem] font-normal opacity-70">
                    Features
                  </span>
                </Button>
              </Link>
          ...
          <div className="flex items-center gap-x-5 ">
            ...
            <Link href="/">
              <svg
                className="h-4 w-4 fill-current hidden md:block"
                height="23"
            ...
            <Button
              asChild
              variant="outline"
              className="flex flex-row text-[1rem] gap-2 items-center justify-center"
            >
              <Link href={"/dashboard"}>
                {" "}
                <svg
