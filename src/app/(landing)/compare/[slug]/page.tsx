    ...
    <main className="relative bg-white">
      ...
      <section className="px-6 pb-20">
        <div className="mx-auto max-w-3xl">
          <h2 className="mb-8 text-center text-2xl font-semibold tracking-tight text-neutral-900">
          ...
          <div className="overflow-hidden rounded-xl border border-neutral-200">
            ...
            <div className="grid grid-cols-3 border-b border-neutral-200 bg-neutral-50">
              <div className="px-5 py-4 text-xs font-medium uppercase tracking-wider text-neutral-400">
                Feature
              </div>
              <div className="border-l border-neutral-200 px-5 py-4 text-xs font-medium uppercase tracking-wider text-neutral-400">
                {competitor.name}
              </div>
              <div className="border-l border-neutral-200 bg-neutral-900 px-5 py-4 text-xs font-medium uppercase tracking-wider text-white">
                iShortn
              </div>
            </div>
            ...
            {featureRows.map((row, i) => (
              ...
              >
                ...
                <div className="border-l border-neutral-100 px-5 py-4 text-sm text-neutral-500">
                  {competitor[row.competitorKey]}
                </div>
                <div className="border-l border-neutral-100 bg-neutral-50 px-5 py-4 text-sm font-medium text-neutral-900">
      ...
      <section className="border-t border-neutral-100 px-6 py-20">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            {/* iShortn pricing */}
            <div className="rounded-xl border-2 border-neutral-900 p-6">
              <h3 className="text-lg font-semibold text-neutral-900">
                iShortn
              </h3>
              <p className="mt-1 text-sm text-neutral-500">
