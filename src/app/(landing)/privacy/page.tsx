...
export const metadata: Metadata = {
  ...
  description: "Learn how iShortn collects, uses, and protects your personal information.",
  openGraph: {
    title: "Privacy Policy - iShortn",
    description: "Learn how iShortn collects, uses, and protects your personal information.",
    type: "website",
      ...
      <section style={{ padding: "24px 0 120px" }}>
        ...
        >
          <p>
            ...
            ishortn.ink. Please read this policy carefully. By using iShortn, you agree to the
          ...
          <p>
            iShortn uses cookies and similar technologies to maintain your session, remember your
          ...
          <p>
            iShortn is not intended for use by children under the age of 13. We do not knowingly
