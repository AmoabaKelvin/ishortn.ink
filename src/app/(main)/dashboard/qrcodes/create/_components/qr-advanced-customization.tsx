...
interface QRAdvancedCustomizationProps {
  ...
  markerFrame: QRMarkerFrame;
  setMarkerFrame: (frame: QRMarkerFrame) => void;
  markerCenter: QRMarkerCenter;
  setMarkerCenter: (center: QRMarkerCenter) => void;
  darkColor: string;
      ...
      <div className="space-y-3">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="space-y-1.5">
            ...
            <Select
              value={pixelStyle}
              onValueChange={selectFromOptions(pixelStyles, setPixelStyle)}
            >
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={markerFrame}
              onValueChange={selectFromOptions(markerFrames, setMarkerFrame)}
            >
              <SelectTrigger className="h-9 border-neutral-200 dark:border-border bg-white dark:bg-card text-[13px]">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={markerCenter}
              onValueChange={selectFromOptions(markerCenters, setMarkerCenter)}
            >
              <SelectTrigger className="h-9 border-neutral-200 dark:border-border bg-white dark:bg-card text-[13px]">
                <SelectValue placeholder="Select inner" />
              </SelectTrigger>
              <SelectContent>
                {markerCenters.map((center) => (
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            ...
            <Select value={effect} onValueChange={selectFromOptions(qrEffects, setEffect)}>
              <SelectTrigger className="h-9 border-neutral-200 dark:border-border bg-white dark:bg-card text-[13px]">
          ...
          {logoImage ? (
            <div className="space-y-3">
              <div className="relative inline-block">
                {/* eslint-disable-next-line next/no-img-element -- data: URL preview of an uploaded logo */}
                <img
                  src={logoImage}
                  alt="Logo preview"
