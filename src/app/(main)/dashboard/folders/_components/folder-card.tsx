        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center gap-2">
              {/* Stretched link: the ::after overlay makes the whole card open the folder. */}
              <Link
                href={href}
                className="truncate text-[14px] font-medium text-neutral-900 dark:text-foreground transition-colors after:absolute after:inset-0 group-hover:text-neutral-600"
              >
                {folder.name}
              </Link>
              {hasRestrictions && (
